...
{	//菜单
    ...
    {	final JDialog fontDialog=new JDialog(this,"字体设置",false);
        ...
        final JLabel sample=new JLabel("陈良项编写的记事本，制作不易！");
    ...
    {	//新建
        ...
        {	editArea.requestFocus();
            JOptionPane.showMessageDialog(this,"这是网址：https://jingyan.baidu.com/article/db55b609cd11bd4ba30a2fd1.html","帮助主题",JOptionPane.INFORMATION_MESSAGE);
            JOptionPane.showMessageDialog(this,"陈良项","制作者",JOptionPane.INFORMATION_MESSAGE);
            JOptionPane.showMessageDialog(this,"男","性别",JOptionPane.INFORMATION_MESSAGE);
        }//帮助主题结束
        //关于
        ...
        {	editArea.requestFocus();
            JOptionPane.showMessageDialog(this,
                    "--------------------------------------------\n"+
                            " 编写者：人工智能学院物联网专业18级本科 陈良项 \n"+
                            " 编写时间：大三上班学期                         \n"+
                            " 本人QQ：2586154625                            \n"+
                            " e-mail：2586154625@qq.com                \n"+
                            " 初学者，一些地方借鉴他人，不足之处希望老师能提出意见，谢谢！  \n"+
                            "--------------------------------------------\n",
